...
{
  public static int widthPx = 1280; // has to be same as size in void setup()
  public static int heightPx = 720; // has to be same as size in void setup()
  ...
  public static float eyeZ = -(heightPx/2.0)/tan(PI*30.0/180.0); // for camera function
